    ...
    return {
      ...
      projects: [
        ...
        },
        {
          ...
          description: 'TezTracker is an open-source Tezos explorer based on the Conseil indexer. Teztracker provides a standard block explorer set of features along with some unique functionality when it comes to statistics and NFT’s.',
        ...
        },
        {
          ...
          description: 'Cosmoscan is the first data and statistics explorer for the Cosmos network. It provides information oт the overall network operations, governance details, validators and much more. This is still an MVP, so if you have any suggestions, please reach out.',
        ...
        },
        {
          ...
          description: 'A robust and full blockchain explorer and API for the Oasis network. Provides the most extensive information on transactions, validators and overall network stats.',
        ...
        },
        {
          ...
          description: 'This plugin provides a convenient development environment for the Parity Substrate framework for the VSCode users.',
        ...
        },
        {
          ...
          description: 'The plugin provides a convenient development environment for the Parity Substrate framework for the VSCode users.\n',
          repository: 'https://github.com/everstake/atom-plugin-substrate',
        },
        {
          name: 'NEO IDE',
          image: `${require('~/assets/images/neo-ide.jpg')}`,
          description: `Create contracts for the Neo blockchain without the need to set up the environment and download packages for developers, just open <a href="http://neo-ide.com/" rel="noopener noreferrer" target="_blank">Neo IDE</a> in your browser and start creating the future.`,
          repository: 'https://github.com/everstake/neo-ide',
        },
        {
          name: 'IOST IDE',
          image: `${require('~/assets/images/iost-ide.jpg')}`,
          description: 'Online IDE for the IOST chain, comes with a set of standard IDE features.',
